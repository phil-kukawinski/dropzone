...
function drawLaunch() {
  ...
  const btns=[
    ...
    {label:'📊  My Scores',       y:H/2+116, bg:'rgba(127,119,221,0.12)',    fg:'#7F77DD',               w:220, border:'#7F77DD'},
    {label:'💎  Shop',            y:H/2+155, bg:'rgba(127,119,221,0.12)',    fg:'#7F77DD',               w:220, border:'#7F77DD'},
    {label:'⚙  Settings',         y:H/2+198, bg:'rgba(255,255,255,0.06)',    fg:'rgba(255,255,255,0.6)', w:220, border:'rgba(255,255,255,0.2)'},
  ];
